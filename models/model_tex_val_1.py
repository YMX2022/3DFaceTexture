...
class BasicModel:
    ...
    def forward(self):
        ...
        self.renderer(self.param, self.detail_tex, self.detail_light)
        self.shape_rt = self.renderer.shape_rt
        self.detail_tex_face_illu = self.renderer.detail_tex_face_illu
        self.detail_illu, self.coarse_illu = self.renderer.detail_illu, self.renderer.coarse_illu
